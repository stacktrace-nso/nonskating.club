...
- [WFTDA Officiating Cues, Codes, and Signals](https://community.wftda.org/resources/document-libraries/competition-documents#officiating) covers verbal and visual cues.
...
The PBM is responsible for the Penalty Box Whiteboard, a handheld whiteboard that is divided into halves by team, and the markers and erasers for that board. These items are usually supplied by the host league.

The penalty box is equipped with colored swatches (often fabric, felt, or tape) to mark the side of the penalty box belonging to each team, and the jammer seat should be marked XXX (WFTDA Tournament Track SEtup Requirements, "Penalty Box" section e. https://static.wftda.com/resources/wftda-tournament-track-setup-requirements.pdf) The Penalty Box Manager may choose to wear colored armbands to associate their hand signals with each team's side of the box.

## The Basic Routine

Work from the center of the penalty box, directly behind the two jammer seats. Most penalty box managers work standing, but you are free to sit if you can do so while executing the role. You can PBM in a face mask. Some box managers choose to wear colored armbands to reflect team colors.
...
Direct the skater to an appropriate seat in the penalty box. (Officiating Procedures 7.2). The Penalty Box Timers may also direct skaters; coordinate how you'd like to direct traffic with the PBTs prior to the game. Blockers and pivots should be seated on the two outer seats of each team's box, and the jammers in the inner seat. If the skater sits in the wrong seat, request that they move, but ensure that their time is started from their initial arrival. (Casebook C4.4.1.A)
...
The Penalty Box Manager should be familiar with all of the [Officiating Cues, Codes, and Signals](https://community.wftda.org/resources/document-libraries/competition-documents#officiating)  related to penalty management. Note that there are many cues beyond "Stand" and "Done"! In particular, you should know how to cue multiple skaters at once, how to assess and signal penalties (see Assessing Penalties, below) and how to manage the queue (see Managing the Queue, below).

Additionally, the Penalty Box Manager should be familiar with the undocumented but fairly standard cues discussed below. XXX

---

XXX reference WFTDA penalty box training
...
When a team's penalty box is filled with two _seated_ skaters, additional incoming skaters should be returned to the track using the "\<Color\> \<Number\>, return to the track" cue. (Rules 4.4.1). This cue is referenced in Officiating Procedures 7.3.1 but is not defined in the Cues, Codes, and Signals document. The hand signal is a "pushing" gesture with an open palm and a horizontally extended arm. Note however that fouled-out skaters should not be returned to the track; see below under Foulouts.
...
Erase queued skaters from your board as they report. Skaters do not have to report in listed order. They should be seated in the order in which they report. (Officiating Procedures 7.3.2)
...
Leaving the penalty box early is an Illegal Procedure. XXX Cite
...
See [Casebook C4.5.B](https://rules.wftda.com/casebook/04_c_penalties.html#fouling-out-and-expulsions).
...
You may ask a jammer who is not wearing the star to show the helmet cover. XXX
...
Self-reports and rescinded penalties often cause Penalty Box Timers' paperwork to fail to match up with the Penalty Lineup Trackers'. XXX

### Conversation in the Box

Skaters may ask questions of the penalty box staff. You're never required to answer a question if it negatively impacts your duties. You _should_ only answer questions that you have accurate, factual answers to: XXX
